...
public:
	...
	int setListenAddr(string& strPort, struct addrinfo **ppresult)
	{
		int iResult;
	...
	int createSocket()
	{
		...
		HWND workerwindow = MakeWorkerWindow();
		WSAAsyncSelect(ListenSocket, workerwindow, WM_SOCKET, FD_ACCEPT | FD_CLOSE);
